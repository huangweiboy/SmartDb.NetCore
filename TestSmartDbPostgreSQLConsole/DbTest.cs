   ...
   public class DbTest
    {
        ...
        public void Insert()
        {
            SqlDb db = new PostgreSqlDb(_connString);
        ...
        public void Query()
        {
            ...
            var pageDataList2 = db.QueryPageList<UserInfo>("UserId,b.UserName", string.Format("UserId>{0}UserId", dbOperator), "UserId", "asc", 10, 1, new { UserId = 2 });
        }
